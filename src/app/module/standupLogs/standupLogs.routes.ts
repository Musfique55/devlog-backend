...
router.post("/",checkAuth(APP_ROLE.USER),StandupLogController.createLog);
...
router.get("/workspace/:workspaceId/blocker/:blocker",checkAuth(APP_ROLE.USER),teamAuth(TEAM_ROLE.ADMIN),StandupLogController.getAllBlockerLogs);
router.delete("/workspace/:workspaceId/:id",checkAuth(APP_ROLE.USER),teamAuth(TEAM_ROLE.ADMIN),StandupLogController.deleteLogFromWorkspace);
